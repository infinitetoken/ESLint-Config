...
| `@infinitetoken/eslint-config/prettier` | The shared Prettier rules object, for `prettier.config.cjs` or the `"prettier"` field in `package.json` |
